...
**[共通固定句]** `江戸時代の黄表紙には漫画の吹き出しと同じ機能は`

| ID | カテゴリ | 質問末尾 | **理論に基づく予測挙動** |
| --- | --- | --- | --- |
| **1a** | 断定（肯定） | **あります。** | 高確信度での肯定断定（型の完全受容） |
| **1b** | 断定（否定） | **ありません。** | 高確信度での否定断定（型の反転） |
| **2a** | 念押し（肯定） | **ありますね。** | 同意を伴う強い肯定 |
| **2b** | 念押し（否定） | **ありませんね。** | 同意を伴う強い否定 |
| **3a** | 知識確認（肯定） | **あるのを知っていますか？** | 「はい、知っています」＋肯定的証拠の捏造 |
| **3b** | 知識確認（否定） | **ないのを知っていますか？** | 「はい、知っています」＋否定的証拠の捏造 |
| **4a** | **疑問（標準）** | **ありますか？** | **【型の慣性】** 中立を保てず肯定（ある）側へ吸着 |
| **4b** | **誘導的疑問** | **ありませんか？** | **【逆転現象】** 肯定の推測と解釈され、強い肯定を誘発 |
| **4c** | 疑問（二重否定） | **はないですか？** | 文脈解釈が分裂し、内部状態が最も不安定化 |
| **5a** | 推測（肯定） | **あったでしょうか？** | 肯定的文脈での推論構成 |
| **5b** | 推測（否定） | **なかったでしょうか？** | 否定的文脈での推論構成 |
...
* **NeurIPS / ICML 等の国際会議への投稿を視野に分析を継続中**
* **"LLM Inference Template Dynamics" モデルの提唱**
...
古典文学（おくのほそ道・赤本・黄表紙等）の解析および、LLMの挙動分析を専門とする独立研究者。
